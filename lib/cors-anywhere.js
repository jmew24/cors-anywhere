...
function getHandler(options, proxy) {
	var corsAnywhere = {
		...
		originWhitelist: [
			'https://player-db.up.railway.app',
			'https://player-db-updater.up.railway.app',
			'https://scoreboard-controller.up.railway.app',
			'https://convocation-controller.up.railway.app',
			'https://convocation-api.up.railway.app',
